...
; XX Axis
    ...
    Apontos3d()\x=tmpx
    Apontos3d()\y=tmpy*Cos(angx)+tmpz*Sin(angx)
    Apontos3d()\z=-tmpy*Sin(angx)+tmpz*Cos(angx)
...
; YY Axis
    ...
    Apontos3d()\x=tmpx*Cos(angy)-(tmpz*Sin(angy))
    Apontos3d()\y=tmpy
    Apontos3d()\z=(tmpx*Sin(angy))+tmpz*Cos(angy)
...
; ZZ Axis
    ...
    Apontos3d()\x=tmpx*Cos(angz)-tmpy*Sin(angz)
    Apontos3d()\y=(tmpx*Sin(angz))+tmpy*Cos(angz)
    Apontos3d()\z=tmpz
...
; XX Axis
  ...
  ax=tmpx
  ay=(tmpy*Cos(angx))+(tmpz*Sin(angx))
  az=(-tmpy*Sin(angx))+(tmpz*Cos(angx))
...
; YY Axis
  ...
  ax=tmpx*Cos(angy)-(tmpz*Sin(angy))
  ay=tmpy
  az=(tmpx*Sin(angy))+(tmpz*Cos(angy))
...
; ZZ Axis
  ...
  ax=tmpx*Cos(angz)-tmpy*Sin(angz)
  ay=(tmpx*Sin(angz))+(tmpy*Cos(angz))
  az=tmpz
